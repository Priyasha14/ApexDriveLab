        ...
        self.samples.append(
            {
                ...
                "ers_total_deployed": car.hybrid_state.total_deployed,
                "ers_total_recovered": car.hybrid_state.total_recovered,
                "gear": car.powertrain_state.gear,
                "rpm": car.powertrain_state.rpm,
                "engine_power_limited": car.powertrain_state.power_limited,
                "drs_active": car.aero_state.drs_active,
                "wing_downforce": car.aero_state.wing_downforce,
                "ground_effect_downforce": car.aero_state.ground_effect_downforce,
                "ride_height": car.aero_state.ride_height,
                "floor_stalled": car.aero_state.floor_stalled,
                "aero_efficiency": car.aero_state.aero_efficiency,
                "brake_temperature": car.brake_state.temperature,
                "brake_performance": car.brake_state.performance,
                ...
                "front_tire_temperature": car.tire_state.front_temperature,
                "rear_tire_temperature": car.tire_state.rear_temperature,
                "front_tire_wear": car.tire_state.front_wear,
                "rear_tire_wear": car.tire_state.rear_wear,
                "front_tire_saturation": car.tire_state.front_saturation,
                "rear_tire_saturation": car.tire_state.rear_saturation,
